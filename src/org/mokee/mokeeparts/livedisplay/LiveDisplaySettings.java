 ...
 */
package org.mokee.mokeeparts.livedisplay;
...
import org.mokee.mokeeparts.search.SearchIndexableRaw;
import org.mokee.mokeeparts.search.Searchable;
import org.mokee.mokeeparts.utils.ResourceUtils;
...
import static mokee.hardware.LiveDisplayManager.FEATURE_ANTI_FLICKER;
...
public class LiveDisplaySettings extends SettingsPreferenceFragment implements Searchable,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (liveDisplayPrefs != null && mAntiFlicker != null &&
                !mHardware.isSupported(MoKeeHardwareManager.FEATURE_ANTI_FLICKER)) {
    ...
    public static final Searchable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
        ...
        public Set<String> getNonIndexableKeys(Context context) {
            ...
            if (!context.getResources().getBoolean(
                    org.mokee.platform.internal.R.bool.config_enableLiveDisplay)) {
                result.add(KEY_LIVE_DISPLAY_TEMPERATURE);
                result.add(KEY_LIVE_DISPLAY);
            }

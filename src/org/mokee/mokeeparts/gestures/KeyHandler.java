...
package org.mokee.mokeeparts.gestures;
...
public class KeyHandler implements DeviceKeyHandler {
    ...
    private static final String GESTURE_WAKEUP_REASON = "mokeeparts-gesture-wakeup";
    ...
    public KeyHandler(final Context context) {
        ...
        mGestureWakeLock = mPowerManager.newWakeLock(
                PowerManager.PARTIAL_WAKE_LOCK, "MoKeePartsGestureWakeLock");
        ...
        if (mProximityWakeSupported) {
            ...
            mProximityWakeLock = mPowerManager.newWakeLock(
                    PowerManager.PARTIAL_WAKE_LOCK, "MoKeePartsProximityWakeLock");
        }

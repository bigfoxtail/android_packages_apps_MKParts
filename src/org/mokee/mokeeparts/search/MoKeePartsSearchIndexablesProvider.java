 ...
 */
package org.mokee.mokeeparts.search;
...
import org.mokee.mokeeparts.search.Searchable.SearchIndexProvider;
import org.mokee.internal.mokeeparts.PartInfo;
import org.mokee.internal.mokeeparts.PartsList;
...
import static org.mokee.internal.mokeeparts.PartsList.MOKEEPARTS_ACTIVITY;

/**
 * Provides search metadata to the Settings app
 */
public class MoKeePartsSearchIndexablesProvider extends SearchIndexablesProvider {

    private static final String TAG = MoKeePartsSearchIndexablesProvider.class.getSimpleName();
    ...
    public Cursor queryXmlResources(String[] strings) {
        ...
        for (String key : keys) {
            ...
            ref[COLUMN_INDEX_XML_RES_INTENT_TARGET_PACKAGE] = MOKEEPARTS_ACTIVITY.getPackageName();
            ref[COLUMN_INDEX_XML_RES_INTENT_TARGET_CLASS] = MOKEEPARTS_ACTIVITY.getClassName();
            cursor.addRow(ref);
        }
        return cursor;
        ...
        for (String key : keys) {
            ...
            for (SearchIndexableRaw raw : rawList) {
                ...
                ref[COLUMN_INDEX_RAW_INTENT_TARGET_PACKAGE] = raw.intentTargetPackage != null ?
                        raw.intentTargetPackage : MOKEEPARTS_ACTIVITY.getPackageName();
                ref[COLUMN_INDEX_RAW_INTENT_TARGET_CLASS] = raw.intentTargetClass != null ?
                        raw.intentTargetClass : MOKEEPARTS_ACTIVITY.getClassName();

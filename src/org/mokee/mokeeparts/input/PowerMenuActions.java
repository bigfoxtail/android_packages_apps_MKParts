...
import mokee.app.MoKeeGlobalActions;
...
public class PowerMenuActions extends SettingsPreferenceFragment {
    ...
    private MoKeeGlobalActions mMoKeeGlobalActions;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mMoKeeGlobalActions = MoKeeGlobalActions.getInstance(mContext);
    ...
    public void onStart() {
        ...
        if (mScreenshotPref != null) {
            mScreenshotPref.setChecked(mMoKeeGlobalActions.userConfigContains(
                    GLOBAL_ACTION_KEY_SCREENSHOT));
        }

        if (mAirplanePref != null) {
            mAirplanePref.setChecked(mMoKeeGlobalActions.userConfigContains(
        ...
        if (mUsersPref != null) {
            if (!UserHandle.MU_ENABLED || !UserManager.supportsMultipleUsers()) {
                ...
                mUsersPref.setChecked(mMoKeeGlobalActions.userConfigContains(
        ...
        if (mBugReportPref != null) {
            mBugReportPref.setChecked(mMoKeeGlobalActions.userConfigContains(
                    GLOBAL_ACTION_KEY_BUGREPORT));
        }

        if (mEmergencyPref != null) {
            mEmergencyPref.setChecked(mMoKeeGlobalActions.userConfigContains(
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        if (preference == mScreenshotPref) {
            ...
            mMoKeeGlobalActions.updateUserConfig(value, GLOBAL_ACTION_KEY_SCREENSHOT);

        } else if (preference == mAirplanePref) {
            value = mAirplanePref.isChecked();
            mMoKeeGlobalActions.updateUserConfig(value, GLOBAL_ACTION_KEY_AIRPLANE);

        } else if (preference == mUsersPref) {
            value = mUsersPref.isChecked();
            mMoKeeGlobalActions.updateUserConfig(value, GLOBAL_ACTION_KEY_USERS);

        } else if (preference == mBugReportPref) {
            value = mBugReportPref.isChecked();
            mMoKeeGlobalActions.updateUserConfig(value, GLOBAL_ACTION_KEY_BUGREPORT);
            Settings.Global.putInt(getContentResolver(),
                    Settings.Global.BUGREPORT_IN_POWER_MENU, value ? 1 : 0);

        } else if (preference == mLockDownPref) {
            value = mLockDownPref.isChecked();
            mMoKeeGlobalActions.updateUserConfig(value, GLOBAL_ACTION_KEY_LOCKDOWN);
            ...
            mMoKeeGlobalActions.updateUserConfig(value, GLOBAL_ACTION_KEY_EMERGENCY);
